...
public class RadiantLinkBehavior extends TileEntityBehaviour {

    public static BehaviourType<RadiantLinkBehavior> TYPE = new BehaviourType<>();
    RadiantChassisTileEntity tile;

    public RadiantLinkBehavior(RadiantChassisTileEntity te) {
        super(te);
        tile = te;
    }
