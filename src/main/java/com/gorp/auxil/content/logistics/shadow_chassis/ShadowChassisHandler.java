...
import com.gorp.auxil.foundation.networking.ShadowChassisPacket;
...
public class ShadowChassisHandler {
    ...
    public static void rightClickingBlocksSelectsThem(PlayerInteractEvent.RightClickBlock event) {
        ...
        String key = ".shadow_chassis.target_set";
    ...
    public static void flushSettings(BlockPos pos) {
        ...
        Channel.channel.sendToServer(new ShadowChassisPacket(pos, currentSelection1, currentSelection2));
        currentItem = null;
    ...
    public static void leftClickingBlocksDeselectsThem(PlayerInteractEvent.LeftClickBlock event) {
        ...
        BlockPos pos = event.getPos();
        TextFormatting color = TextFormatting.WHITE;
        String key = ".shadow_chassis.target_unset";
    ...
    public static void tick() {
        ...
        if (!AllBlocks.SHADOW_CHASSIS.isIn(heldItemMainhand)) {
            currentItem = null;
        } else {
